...
# Try to win slot machine with presudo random results
...
class MenuScene():
    ...
    def update(self):
        ...
        thumby.display.drawText("A-Game B-Bet", 5, 30, 1)
...
class GameScene():
    ...
    def update(self):    
        ...
        if (thumby.buttonA.justPressed()):
            ...
            if (self.over):
                ...
                self.ySpeed0 = 3 + random.randint(0, 3)
                self.ySpeed1 = 5 + random.randint(0, 3)
                self.ySpeed2 = 7 +random.randint(0, 3)
                self.running = True
        
        
        if (thumby.buttonU.justPressed() and self.isWillStop() ):
            if(self.bet+5<=self.cash):
                self.bet+=5;
    ...
    def drawGame(self):        
        ...
        # thumby.display.drawLine(0,16,72,16,0)
        # thumby.display.drawLine(0,33,72,33,0)
        # print(self.getCombination())
    ...
    def drawLegend(self):    
        ...
        thumby.display.drawText("Combination", 5, 10, 0)
        #TODO
        thumby.display.update()   
